...
/**
 * Implementation class of VendingMachine interface
...
public class VendingMachineImpl implements VendingMachine {
	...
	private void initialize(){       
		...
		//initialize machine with 5 cans of each Item       
	...
	NotFullPaidException{
		if(isFullPaid()){
			...
			throw new NotSufficientChangeException(
					"Not Sufficient change in Inventory");
		...
		if(amount > 0){
			...
			while(balance > 0){
				if(balance >= Coin.QUARTER.getDenomination() 
					...
					throw new NotSufficientChangeException(
							"NotSufficientChange, Please try another product");
				}
			}
		}
