...
public class BinarySearchInDSA {

	public static int search(int[] arr, int value) {
		BinarySearchInDSA binarySearchInDSA = new BinarySearchInDSA();
//		return binarySearch.binarySearch(arr, 0, arr.length - 1, value);
		return binarySearchInDSA.binarySearchRecursive(arr, 0, arr.length - 1, value);
	}
